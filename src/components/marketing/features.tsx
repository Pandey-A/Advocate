            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Legal work and matters <br /> made <span className="font-subheading italic">simple</span>
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Empower your advocacy with AI-driven tools. Streamline case management, draft documents efficiently, and deliver smarter legal solutions for your clients.
                    </p>
                </div>
            </Container>
