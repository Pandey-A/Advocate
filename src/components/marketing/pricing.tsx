                ...
                <Container>
                    <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                        ...
                        <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                            Transform your legal practice with AI-powered automation. Streamline case research, generate legal documents faster, and make informed decisions with intelligent insights.
                        </p>
                    </div>
                </Container>
...
const Plan = ({ plan, billPlan }: { plan: PLAN, billPlan: Plan }) => {
    return (
        <div className={cn(
            ...
            plan.title === "Law Firm Pro" && "border-blue-500"
        )}>
            {plan.title === "Law Firm Pro" && (
            ...
            <div className="flex flex-col items-start w-full px-4 py-2 md:px-8">
                <Button size="lg" variant={plan.title === "Law Firm Pro" ? "blue" : "white"} className="w-full">
                    {plan.buttonText}
                </Button>
